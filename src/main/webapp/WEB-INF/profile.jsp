		...
		<div class="container">
			...
			<div class="collapse navbar-collapse">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item">
						<a class="nav-link" href="/add/recipe" data-scroll="true" href="javascript:void(0)">Share a Recipe</a>
					</li>
					<li class="nav-item">
            ...
            <div class="container">
                ...
                <div class="tab-content">
	                    ...
	                    <div class="col-md-auto col-sm-6">
	                        <div class="card-big-shadow">
	                            <div class="card card-just-text" data-background="color" data-color="blue" data-radius="none">
	                                <div class="card-body">
	                                    <h4 class="card-title">Your Favorites <i class="fa fa-heart heart"></i></h4>
	                                    <ul class="my_list">
	                        ...
	                        <div class="card-big-shadow">
	                            <div class="card card-just-text" data-background="color" data-color="green" data-radius="none">
	                                <div class="card-body">
	                                    ...
	                                    <h4 class="card-title">Your Contribution</h4>
	                                    <ul class="my_list">
	                                    	<c:forEach items="${currentUser.recipes}" var="recipes">
	                                    	<li>
	                                    		<a class="card-description" href="/show/recipe/${recipes.id}">${recipes.title}</a><br> 
	                                    		<a href="/edit/${recipes.id}" id="edit_link">Edit</a> | <a href="/delete/${recipes.id}" id="delete_link">Delete</a>
	                                    	</li>
	                                    	</c:forEach>
	                                    </ul>
	                                </div>
                    ...
                    <div class="tab-pane text-center" id="following" role="tabpanel">
                        ...
                        <a class="btn btn-warning btn-round" id="edit-btn" href="/edit/profile/${currentUser.id}">Edit Profile</a>
                    </div>
                </div>
